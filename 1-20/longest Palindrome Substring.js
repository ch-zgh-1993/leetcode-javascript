...
* @Last Modified time: 2020-04-21 19:46:05
...
// 反转字符串， 特殊情形，长度为 1, 长度等于字符串的长度。开始位置，截止位置的起始为开始位置 + 已有长度。
/**
 * @param {string} s
 * @return {string}
 */
...
// 补充：
// 思路4: 260ms 51%; 80.3 50%
// 动态规划： 
// 寻找状态 '' true, false，状态转移方程 S(i, j) S(i -1, j + 1)，初始化，输出，状态数组压缩
// 
